...
- I created a system tray app with a red/green icon.  It can connect/disconnect, auto-connect/reconnect, you can select which profile you want and it kills/reloads the wiresock-client.exe process.  Monitors connectivity.  Takes up 2mb of ram.
